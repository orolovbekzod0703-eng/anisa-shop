...
const TELEGRAM = 'https://t.me/Anisashop_admin'
const INSTAGRAM = 'https://www.instagram.com/anisa_shop_olmaliq/'
const PHONE = '+998949232689'
const PHONE_FMT = '+998 94 923 26 89'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 grid gap-8 sm:grid-cols-3">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><FooterLink onClick={goCategories}>{t.categories}</FooterLink></li>
            <li><FooterLink onClick={() => setFavoritesOpen(true)}>{t.favorites}</FooterLink></li>
            <li><FooterLink onClick={() => setCartOpen(true)}>{t.cart}</FooterLink></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-brand-500">
            ...
            <li>
              <a href={TELEGRAM} target="_blank" rel="noreferrer" className="hover:text-brand-700 transition">Telegram: @Anisashop_admin</a>
            </li>
            <li>
              <a href={INSTAGRAM} target="_blank" rel="noreferrer" className="hover:text-brand-700 transition">Instagram: @anisa_shop_olmaliq</a>
            </li>
