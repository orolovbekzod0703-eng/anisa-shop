...
export function placeholderFor(product, variant = 0) {
  ...
  const icon = CATEGORY_ICON[product?.category] || CATEGORY_ICON.dresses
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 800" preserveAspectRatio="xMidYMid slice">
    ...
    <text x="300" y="680" text-anchor="middle" fill="#ffffff" font-family="Inter, system-ui, sans-serif" font-weight="500" font-size="20" opacity="0.75">${esc(brand)}</text>
