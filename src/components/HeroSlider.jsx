...
export function HeroSlider() {
  const { t } = useI18n()
  const slides = [
    { title: t.heroTitle1, sub: t.heroSub1, bg: 'from-brand-700 to-brand-500', img: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?auto=format&fit=crop&w=1200&q=80' },
    { title: t.heroTitle2, sub: t.heroSub2, bg: 'from-brand-800 to-brand-600', img: 'https://images.unsplash.com/photo-1551048632-24e444b48a3e?auto=format&fit=crop&w=1200&q=80' },
    { title: t.heroTitle3, sub: t.heroSub3, bg: 'from-brand-600 to-brand-400', img: 'https://images.unsplash.com/photo-1544022613-e87ca75a784a?auto=format&fit=crop&w=1200&q=80' }
  ]
            ...
            <div key={idx} className="w-full shrink-0 relative">
              <div className={`h-52 sm:h-72 md:h-96 bg-gradient-to-r ${s.bg} relative overflow-hidden`}>
                ...
                <div className="relative z-10 h-full flex flex-col justify-center px-6 sm:px-12 text-white max-w-lg">
                  <div className="uppercase text-[11px] tracking-[.25em] opacity-80">Anisa Shop</div>
